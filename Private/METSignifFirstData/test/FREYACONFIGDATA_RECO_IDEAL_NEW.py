...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('FREYACONFIG_DATA_RECO_fromConfig.root'),
...
process.metreco_step = cms.Path(process.calolocalreco+process.caloTowersRec+process.metreco+process.recoPFMET)

# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1GtObjectMap_step,process.L1Reco_step,process.metreco_step,process.endjob_step,process.out_step)
