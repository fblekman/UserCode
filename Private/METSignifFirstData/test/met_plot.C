{
  ...
  TH1D *hist1 = new TH1D("hist1","CMS at #sqrt{s}=900 GeV",50,0,50);
  hist1->SetXTitle("missing E_{T} (GeV)");
  ...
  chdata->Draw("met.met>>hist1","","goff");
  chmc->Draw("met.met>>hist2","","goff");
  ...
  leg->Draw("same");
  c1->Modified();
  c1->Print("met_CMSSW341_900GeV.pdf");
  c1->Print("met_CMSSW341_900GeV.jpg");
