#ifndef CRAFTDELEGATE_H_
#define CRAFTDELEGATE_H_
 ...
 * @date April 2009
 */
class CRAFTDelegate : public pftools::EventDelegate {

public:
	CRAFTDelegate();

	virtual ~CRAFTDelegate() {
		LogDebug("CRAFTDelegate") << "Leaving "<< __PRETTY_FUNCTION__ << std::endl;
	}
...
private:
	...
	edm::InputTag inputCosmicMuons_;
	...
	edm::Handle<std::vector<reco::Track> >* cosmicTracks_;
